...
-- El flujo de compra ya no muestra estados de pedido al cliente.
-- Se mantiene la columna estado como dato técnico para compatibilidad con JPA.
-- Las compras actuales y futuras quedan normalizadas como COMPLETADA.
